...
def write_note(note, file_path=notebook_path):
    """Write a note to the notebook."""
    with open(file_path, "a") as file:
        file.writelines(note + "\n")
        
def list_notes(file_path=notebook_path):
...
def delete_note(note_index, file_path=notebook_path):
...
def edit_note(note_index, file_path=notebook_path):
